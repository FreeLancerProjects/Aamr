package com.endpoint.Aamr.activities_fragments.activity_map;
...
import com.endpoint.Aamr.models.SelectedLocation;
...
private Button bt_select;
    ...
    private void initView() {
       ...
       ed_search=findViewById(R.id.edtSearch);
       ...
       ed_search.setOnEditorActionListener((v, actionId, event) -> {
            if (actionId == EditorInfo.IME_ACTION_SEARCH) {
                ...
                if (!TextUtils.isEmpty(query)) {
                    Common.CloseKeyBoard(MapActivity.this,ed_search);
                    Search(query);
                    return false;
                }
            }
