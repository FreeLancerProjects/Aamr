    ...
    public class MyHolder extends RecyclerView.ViewHolder {
        ...
        public void BindData(NearbyModel nearbyModel) {
         /*   if (nearbyModel.getPhotos().size()>0)
            {
                String url = "https://maps.googleapis.com/maps/api/place/photo?maxwidth=400&photoreference="+nearbyModel.getPhotos().get(0).getPhoto_reference()+"&key=AIzaSyA6QI378BHt9eqBbiJKtqWHTSAZxcSwN3Q";
